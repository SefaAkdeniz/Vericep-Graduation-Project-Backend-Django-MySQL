...
class CreditCardAdmin(admin.ModelAdmin):
    list_display = ('user', 'card_name', 'card_number', 'expiration_date_month','expiration_date_year')
    list_display_links = ('card_name', 'card_number', 'expiration_date_month','expiration_date_year')
    list_filter = ('user',)
    list_editable = ('user',)
